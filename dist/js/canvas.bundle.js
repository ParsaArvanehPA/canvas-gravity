...
var gravity = 1;
var frictionDy = 0.925;
var frictionDx = 0.5; // Event Listeners
  ...
  _createClass(Ball, [{
    ...
    value: function update() {
      if (this.y + this.radius + this.dy >= canvas.height) {
        this.dy = -this.dy * frictionDy;
      } else {
        this.dy += gravity;
      }

      if (this.x + this.radius + this.dx > canvas.width || this.x - this.radius <= 0) {
        this.dx = -this.dx * frictionDx;
      }
...
function init() {
  ...
  for (var i = 0; i < 600; i++) {
    ...
    balls.push(new Ball(x, y, dx, dy, radius, Object(_utils__WEBPACK_IMPORTED_MODULE_0__["randomColor"])(colors)));
  }
} // Animation Loop
